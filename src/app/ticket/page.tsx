...
const SECTOR_KEY = "ticket";
const COVER_IMAGE = "/images/ticket/ticket-cover.jpg";
const DESCRIPTION_IMAGE = "/images/ticket/ticket-dis.jpg";
...
export default function TicketPage() {
  ...
  const placeholderAlt = t.placeholderMetaData.ticketAlt;
