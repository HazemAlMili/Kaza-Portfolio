...
const SECTOR_KEY = "breakfast";
const IMAGE_URL = "https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?auto=format&fit=crop&q=80&w=1200";
      ...
      <div>
        ...
        <section ref={containerRef} className="relative h-[60vh] w-full overflow-hidden flex items-center justify-center pt-20">
          <div className="sector-hero-bg absolute inset-0 z-0 w-full h-[120%] -top-[10%]">
            ...
            <Image
              src={IMAGE_URL}
              alt={sectorData.title || "Breakfast"}
              fill
              priority
