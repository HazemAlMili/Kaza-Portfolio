...
const SECTOR_KEY = "entertainment";
const COVER_IMAGE = "/images/entertainment/entertainment-cover.jpg";
const DESCRIPTION_IMAGE = "/images/entertainment/entertainment-dis.jpg";
...
export default function EntertainmentPage() {
  ...
  const placeholderAlt = t.placeholderMetaData.entertainmentAlt;
